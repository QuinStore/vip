...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/QuinStore/vip/main/Insshws/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/QuinStore/vip/main/configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/QuinStore/vip/main/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/QuinStore/vip/main/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/QuinStore/vip/main/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/QuinStore/vip/main/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/QuinStore/vip/main/scurity/rules.zip
unzip rules.zip
...
wget -q -O /etc/cyber.site "https://raw.githubusercontent.com/QuinStore/vip/main/issue.net"
...
wget https://raw.githubusercontent.com/QuinStore/vip/main/Insshws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
